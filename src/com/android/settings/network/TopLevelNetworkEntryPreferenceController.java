    ...
    public CharSequence getSummary() {
        if (mMobileNetworkPreferenceController.isAvailable()) {
            return BidiFormatter.getInstance()
                    .unicodeWrap(mContext.getString(R.string.network_dashboard_summary_mobile_beach));
        } else {
            return BidiFormatter.getInstance()
                    .unicodeWrap(mContext.getString(R.string.network_dashboard_summary_no_mobile_beach));
        }
    }
}
